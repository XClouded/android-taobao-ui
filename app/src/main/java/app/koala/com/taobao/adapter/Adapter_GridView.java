package app.koala.com.taobao.adapter;//// Created by Chaos on 3/25/2015.
...
public class Adapter_GridView extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = LayoutInflater.from(this.context).inflate(R.layout.adapter_grid_home,null);
